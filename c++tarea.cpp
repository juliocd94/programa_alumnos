...
cout<<"--------------------------------------------------------------"<<endl;
	...
	if(hayregistros7 == 0 & hayregistros8 == 0 & hayregistros9 == 0){
		...
		cout<<endl<<"Presione 1 para mostrar resultados "<<endl;
		cin>>operacion;
		if(operacion ==1){
			if(hayregistros7 == 1){
				...
				for(int j=0; j<cuantos_7; j++){
					promedio_curso7 = promedio_curso7 + septimo_grado_notas[j][5];
				}
			...
			if(octavo_grado_notas[mayor_index8][5]>mayor){
				...
				if(septimo_grado_notas[mayor_index7][5]>mayor){
					...
					cout<<"El mejor estudiante del colegio es: "<<octavo_grado[mayor_index8][0]<<" con un promedio de: "<<octavo_grado_notas[mayor_index8][5]<<endl;
				}
			}else if(septimo_grado_notas[mayor_index7][5]>mayor){
				cout<<"El mejor estudiante del colegio es: "<<septimo_grado[mayor_index7][0]<<" con un promedio de: "<<septimo_grado_notas[mayor_index7][5]<<endl;
			}else{
				cout<<"El mejor estudiante del colegio es: "<<noveno_grado[mayor_index9][0]<<" con un promedio de: "<<noveno_grado_notas[mayor_index9][5]<<endl;
			}
